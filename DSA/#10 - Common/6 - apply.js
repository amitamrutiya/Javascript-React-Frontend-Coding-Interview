...
const result1 = product.apply([20, 5]);
console.log(result1); // NaN

const result2 = product.apply(this, [20, 5]);
...
const result3 = person.fullName.apply(person1);
console.log(result3); // John Doe

const result4 = person.fullName.apply(person2);
